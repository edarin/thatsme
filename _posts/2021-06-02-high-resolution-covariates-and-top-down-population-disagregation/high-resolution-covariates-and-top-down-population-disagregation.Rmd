---
title: "What is the impact of very-high resolution covariates on top-down population models?"
description: |
  We will study the use of very high-resolution covariates in top-down population model and its impact on population gridded estimates. We will examine building-footprint derived covariates in Sierra Leone population model.
author:
  - name: 'Edith Darin'
date: 06-02-2021
output:
