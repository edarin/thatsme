...
description: |
  I have co-authored an R tutorial on how to develop top-down population models, which consists in disaggregating administrative estimates to a finer spatial resolution. We  first shared this tutorial with the Brazilian Stats Office (IGBE).
author:
...
citation_url: "https://github.com/wpgp/top-down-tutorial/blob/master/4_tutorial.html"
header-includes:
   - \usepackage{amsmath}
bibliography: references.bib
link-citations: yes
preview: "./dat/schema.jpg"
output:
...
[here](https://github.com/wpgp/top-down-tutorial).
...
knitr::include_graphics(here('_posts','2021-07-02-top-down-r-tutorial', 'dat', 'boundaries.png'))
...
```{r schema, echo=F, eval=T, warning=T, fig.cap='Modelling Process', out.width = "100%", fig.align="center", preview=TRUE}
knitr::include_graphics(here('_posts','2021-07-02-top-down-r-tutorial', 'dat', 'schema.jpg'))
```
...
covariates [@breiman2001; @stevens2015]. Each regression tree identifies
...
master_train <- read.csv(here('_posts','2021-07-02-top-down-r-tutorial', 'dat', "master_train.csv"))
master_predict <- read.csv(here('_posts','2021-07-02-top-down-r-tutorial', 'dat', "master_predict.csv"))
```
...
```{r, eval=T, echo=F, results=F}
load(here('_posts','2021-07-02-top-down-r-tutorial', 'dat', 'popfit.Rdata'))
```
...
knitr::include_graphics(here('_posts','2021-07-02-top-down-r-tutorial', 'dat', 'in-out.png'))
...
[@pebesma2018simple] to read and manipulate GIS vector data (census EAs,
in this case).
...
[-@worldpop2018mastergrid]. In this mastergrid, any cells that contain a
